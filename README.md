...
- A fixed black off screen with a centered, filled, antialiased red camera-off asset is actively published at 30 fps while automation is stopped and generated by the virtual camera whenever the app publisher is absent.
- Dashboard, four settings categories, contextual previews, tray/close-to-tray, warning notifications, exit confirmation, 14-day JSONL logs, and webcam/screen/virtual/all restarts.
