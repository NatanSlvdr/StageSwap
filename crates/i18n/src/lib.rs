...
pub fn text<'a>(locale: Locale, source: &'a str) -> Cow<'a, str> {
    Cow::Borrowed(catalog!(locale, source, {
        ...
        "Continuing installs the updated managed copy of StageSwap for this user." => ("Continuer installe la copie gérée et mise à jour de StageSwap pour cet utilisateur.", "Continuar instala la copia administrada y actualizada de StageSwap para este usuario."),
        "Download, install, and restart {0}" => ("Télécharger, installer et redémarrer {0}", "Descargar, instalar y reiniciar {0}"),
