...
pub fn text<'a>(locale: Locale, source: &'a str) -> Cow<'a, str> {
    Cow::Borrowed(catalog!(locale, source, {
        ...
        "Set up automatic switching between your webcam and secondary screen in Zoom." => ("Configurez le changement automatique entre votre webcam et l’écran secondaire dans Zoom.", "Configura el cambio automático entre la cámara web y la pantalla secundaria en Zoom."),
        "Choose the webcam Zoom shows when JW Library is not playing media." => ("Choisissez la webcam à afficher dans Zoom lorsqu’aucun média n’est affiché dans JW Library.", "Elige la cámara web que Zoom mostrará cuando JW Library no reproduzca contenido multimedia."),
        ...
        "Capture the reference image StageSwap uses for automatic switching." => ("Capturez l’image de référence utilisée par StageSwap pour le changement automatique.", "Captura la imagen de referencia que StageSwap usa para el cambio automático."),
        "Inspect component status, technical details, logs, and tools." => ("Consultez l’état des composants, les détails techniques, les journaux et les outils.", "Consulta el estado de los componentes, los detalles técnicos, los registros y las herramientas."),
        ...
        // General settings.
        "StageSwap automatically switches what Zoom shows. When the secondary screen matches the reference image, Zoom shows the webcam. When media is detected, Zoom shows the secondary screen. When no media is detected again, Zoom returns to the webcam." => ("StageSwap change automatiquement ce qui s’affiche dans Zoom. Lorsque l’écran secondaire correspond à l’image de référence, Zoom affiche la webcam. Lorsqu’un média est détecté, Zoom affiche l’écran secondaire. Dès qu’aucun média n’est détecté, Zoom revient à la webcam.", "StageSwap cambia automáticamente lo que muestra Zoom. Cuando la pantalla secundaria coincide con la imagen de referencia, Zoom muestra la cámara web. Cuando se detecta contenido multimedia, Zoom muestra la pantalla secundaria. Cuando deja de detectarse contenido multimedia, Zoom vuelve a la cámara web."),
        ...
        "This is the secondary screen JW Library uses for presentations. Auto mode watches it for media changes." => ("Il s’agit de l’écran secondaire utilisé par JW Library pour les présentations. Le mode Auto le surveille pour détecter les changements de média.", "Esta es la pantalla secundaria que JW Library usa para las presentaciones. El modo Auto la vigila para detectar cambios de contenido multimedia."),
        ...
        "Reference image" => ("Image de référence", "Imagen de referencia"),
        "No media: Camera. Media detected: Screen. Without a reference image, Auto mode stays on Camera." => ("Aucun média : Caméra. Média détecté : Écran. Sans image de référence, le mode Auto reste sur Caméra.", "Sin contenido multimedia: Cámara. Contenido multimedia detectado: Pantalla. Sin una imagen de referencia, el modo Auto permanece en Cámara."),
        "No reference image — show JW Library with no media playing, then capture it." => ("Aucune image de référence — affichez JW Library sans média, puis capturez l’image.", "No hay imagen de referencia: muestra JW Library sin reproducir contenido multimedia y captura la imagen."),
        ...
        "Current status of each video component." => ("État actuel de chaque composant vidéo.", "Estado actual de cada componente de video."),
        "Virtual camera" => ("Caméra virtuelle", "Cámara virtual"),
        "Screen capture" => ("Capture d’écran", "Captura de pantalla"),
        "Tools" => ("Outils", "Herramientas"),
        "Rescan finds the secondary screen. Restart buttons reconnect only the named component." => ("La recherche retrouve l’écran secondaire. Les boutons de redémarrage reconnectent uniquement le composant indiqué.", "La búsqueda encuentra la pantalla secundaria. Los botones de reinicio solo vuelven a conectar el componente indicado."),
        ...
        "Identifiers, formats, and timing used by the active video output." => ("Identifiants, formats et temporisation utilisés par la sortie vidéo active.", "Identificadores, formatos y tiempos utilizados por la salida de video activa."),
        ...
        "Automatically switch Zoom between the webcam and JW Library presentations." => ("Passez automatiquement de la webcam aux présentations JW Library dans Zoom.", "Cambia automáticamente en Zoom entre la cámara web y las presentaciones de JW Library."),
        "No media in JW Library → Zoom shows the webcam" => ("Aucun média affiché dans JW Library → Zoom affiche la webcam", "Sin contenido multimedia en JW Library → Zoom muestra la cámara web"),
        "Media detected in JW Library → Zoom shows the secondary screen" => ("Média détecté dans JW Library → Zoom affiche l’écran secondaire", "Contenido multimedia detectado en JW Library → Zoom muestra la pantalla secundaria"),
        ...
        "Choose the webcam Zoom should show when JW Library is not playing media." => ("Choisissez la webcam que Zoom doit afficher lorsqu’aucun média n’est affiché dans JW Library.", "Elige la cámara web que Zoom debe mostrar cuando JW Library no reproduzca contenido multimedia."),
        ...
        "Capture the JW Library screen shown when no media is playing as the reference image." => ("Capturez comme image de référence l’écran JW Library sans média affiché.", "Captura como imagen de referencia la pantalla de JW Library que aparece cuando no se reproduce contenido multimedia."),
        "Return JW Library to the screen shown when no media is playing, then capture the live image below." => ("Revenez à l’écran JW Library sans média affiché, puis capturez l’image en direct ci-dessous.", "Vuelve a la pantalla de JW Library que aparece cuando no se reproduce contenido multimedia y captura la imagen en directo que aparece abajo."),
        "Example with no media" => ("Exemple sans média", "Ejemplo sin contenido multimedia"),
        "The real screen shown when no media is playing has centered text and a gray square in the corner; this example uses unbranded shapes." => ("L’écran réel sans média affiché comporte du texte centré et un carré gris dans un coin ; cet exemple utilise des formes sans marque.", "La pantalla real que aparece cuando no se reproduce contenido multimedia tiene texto centrado y un cuadrado gris en una esquina; este ejemplo usa formas sin marca."),
        "Prepare JW Library" => ("Préparez JW Library", "Prepara JW Library"),
        "Show the normal JW Library screen with no media playing, centered text, and a gray square in the corner." => ("Affichez l’écran JW Library normal sans média, avec son texte centré et un carré gris dans un coin.", "Muestra la pantalla normal de JW Library sin contenido multimedia, con texto centrado y un cuadrado gris en una esquina."),
        ...
        "Check the live preview, then capture the screen with no media playing as the reference image." => ("Vérifiez l’aperçu en direct, puis capturez comme image de référence l’écran sans média affiché.", "Comprueba la vista previa en directo y captura como imagen de referencia la pantalla sin contenido multimedia."),
        ...
        "Make sure this image shows JW Library with no media playing." => ("Vérifiez que cette image montre JW Library sans média affiché.", "Comprueba que esta imagen muestre JW Library sin reproducir contenido multimedia."),
        "Example reference image" => ("Exemple d’image de référence", "Ejemplo de imagen de referencia"),
        "Your JW Library screen with no media playing should look like this example." => ("Votre écran JW Library sans média affiché doit ressembler à cet exemple.", "La pantalla de JW Library sin contenido multimedia debe parecerse a este ejemplo."),
        ...
        "Open the JW Library presentation, choose StageSwap in Zoom, and start automatic switching." => ("Ouvrez la présentation JW Library, choisissez StageSwap dans Zoom et activez le changement automatique.", "Abre la presentación de JW Library, elige StageSwap en Zoom y activa el cambio automático."),
        ...
        "Set up the webcam, secondary screen, reference image, and Zoom output." => ("Configurez la webcam, l’écran secondaire, l’image de référence et la sortie Zoom.", "Configura la cámara web, la pantalla secundaria, la imagen de referencia y la salida de Zoom."),
...
mod tests {
    ...
    fn jw_library_workflow_copy_is_localized_in_every_supported_language() {
        let strings = [
            ...
            "Capture reference image",
            "Capture the JW Library screen shown when no media is playing as the reference image.",
            "Return JW Library to the screen shown when no media is playing, then capture the live image below.",
            "Example with no media",
            "The real screen shown when no media is playing has centered text and a gray square in the corner; this example uses unbranded shapes.",
            "Prepare JW Library",
            "Show the normal JW Library screen with no media playing, centered text, and a gray square in the corner.",
            "Change display",
            "Choose a display",
            "What to capture",
            "Choose the secondary screen before capturing a reference image.",
            "Check the live preview, then capture the screen with no media playing as the reference image.",
            ...
            "This is the secondary screen JW Library uses for presentations. Auto mode watches it for media changes.",
            "Live secondary screen",
            "No secondary screen image — choose a screen or use Tools in Diagnostics.",
            "No media: Camera. Media detected: Screen. Without a reference image, Auto mode stays on Camera.",
