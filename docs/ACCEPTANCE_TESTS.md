...
11. Stop automation and verify that the dashboard output and virtual-camera consumer both show the same black frame with a centered red crossed-camera icon. Terminate the tray application and verify that the consumer continues showing that off frame. Repeat switching without functional failure.
